---
title: 'Atlas of the Future: School''s out! This learning community is in'
date: 2020-10-15
...
Christopher Pommerening, Dr. Stephen Harris and Blair MacLaren all believe that it’s time for schools to move away from what was once thought of as “school’ – because it’s collaborative learning communities that will be the true driver behind positive societal change. That’s why, in 2017, they founded [Learnlife](https://learnlife.com/).

![](images/25526/02.jpg)

“I have been in education for more than 40 years and a school leader for 30 years,” [Stephen,](https://stephenharris.me/) Learnlife’s Co-founder and Chief Learning Officer, tells us. ”I have taken the opportunity at this point in my career to join with like-minded people from different spheres of life to build the global momentum for change.” 
...
This is not a new model for learning, like the reality-focused [Montessori](https://en.wikipedia.org/wiki/Montessori_education) and playful [Steiner](https://www.steinerwaldorf.org/steiner-education/what-is-steiner-education/) schools, because Learnlife does not operate schools. Instead, creative and problem-solving ‘Learnlife Hubs’ are supported by a wider ‘Alliance’ of over 300 global thought leaders in 50 countries – like psychologist Alfredo Hernando,  designer Rosan Bosch, chef Ferran Adrià and educator [David Price](https://atlasofthefuture.org/meet-learning-futurist-david-price/).
...
There are now three physical Hubs in action – the [Urban Hub](https://learnlife.com/barcelona) (Barcelona) for teenagers; the Nature Hub (in outer Barcelona) for younger children and, inspired by the needs made evident with the pandemic, the [Learnlife Remote Hub](https://learnlife.com/blog/the-transition-to-remote-learning), which is accessible by anyone, anywhere and anytime. There are also more than 30 groups around the world who are currently working out their own versions of the ‘Learnlife paradigm’, contextualised for their specific communities. 
...
Read more ► Learnlife was mapped by [David Price](https://atlasofthefuture.org/education-futurehero-david-price/) in his [AtlasChart Top 5](https://atlasofthefuture.org/education-david-price-atlaschart-top-5/) – a journey through five schools doing things differently from Cambodia to Catalonia.

* [Learnlife Barcelona](https://learnlife.com/barcelona)
...
SOURCE: [ATLAS OF THE FUTURE](https://atlasofthefuture.org/project/learnlife/)
