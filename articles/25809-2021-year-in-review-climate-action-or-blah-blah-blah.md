---
title: '2021 Year in Review: Climate action, or blah, blah, blah?'
date: 2022-01-04
category: Climate
source: ON Network
source_url: null
...
**This year saw another steady stream of [UN](https://www.developmentaid.org/#!/donors/view/118382/un)-backed reports reinforcing a stark message: man-made climate change is an urgent and even existential threat to life on Earth. Will the international community’s efforts to tackle the crisis, as seen at the [COP26](https://www.developmentaid.org/#!/news-stream/post/58577/un-climate-change-conference-of-the-parties-cop26) UN Climate Conference, result in meaningful action?**

### Heading into uncharted territory

To avoid catastrophic climate change, [global temperatures rise](https://www.developmentaid.org/#!/news-stream/post/127111/global-warming-and-climate-change-definition-and-differences) to need to be kept to a maximum of 1.5 degrees above pre-industrial levels, but the odds of the world getting hotter in the next five years continue to increase.

The [World Meteorological Organisation’s (WMO)](https://www.developmentaid.org/#!/donors/view/118449/wmo) flagship State of the Global Climate report warned in April that the global average temperature had already risen by about 1.2 degrees, and a UN Environment study in October revealed that, unless commitments to cut harmful greenhouse gas emissions are not improved, the world is on track to warm by 2.7 degrees this century.
...
A key [UN Environment (UNEP)](https://www.developmentaid.org/#!/donors/view/118390/unep) report in November pointed out that even if countries were to turn the emissions tap off, climate impacts would remain, for decades to come.

“We need a step-change in adaptation ambition for funding and implementation to significantly reduce damages and losses from climate change,” said UNEP chief Inger Andersen. “And we need it now.”

### Fossil fuels continue to burn

The world also needs to speed up the worldwide transition to cleaner forms of energy and end the use of coal, if we are to stand a chance of limiting temperature rises.
...
### These findings were laid out in the latest UN [Production Gap report](https://www.developmentaid.org/#!/news-stream/post/116423/fossil-fuel-production), which included profiles for 15 major fossil fuel-producing countries, showing that most will continue to support fossil fuel production growth.
...
Meanwhile, with more than a million species at risk of extinction, UN chief António Guterres called on countries to work together to ensure a sustainable future for people and the planet, as the first part of the [UN Biodiversity Conference](https://www.developmentaid.org/#!/news-stream/post/112728/world-biodiversity-summit) opened in October (the second part is scheduled to take place in Spring 2022).
...
More than a decade ago, developed countries committed to jointly mobilize $100 billion per year by 2020 in support of [climate action](https://www.developmentaid.org/#!/news-stream/post/129037/climate-intelligence) in developing countries. However, the figure has never been met.
...
Some 77 countries, including 46 countries such as Poland, Vietnam, and Chile, 23 of which are making commitments on ending coal for the first time, are members. However, the biggest coal financiers (China, Japan, and the Republic of Korea) did not join.
...
SOURCE: [DEVELOPMENT AID](https://www.developmentaid.org/#!/news-stream/post/130759/climate-action-2021-review?utm_source=Newsletter&utm_medium=Email&utm_campaign=NewsDigest&token=d2149963-06e8-11ea-8cc5-52540068df95)
