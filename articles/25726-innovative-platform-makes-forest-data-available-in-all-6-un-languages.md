---
title: Innovative Platform Makes Forest Data Available in All 6 UN Languages
date: 2021-05-01
...
The Food and Agriculture Organization of the UN (FAO) is unveiling the language adaptations of our innovative open data [platform](https://fra-data.fao.org/) on forests. First launched in English in July 2020, and recently translated in Arabic, Chinese, French, Spanish and Russian, the platform aims to bolster global efforts to tackle climate change, halt deforestation, and increase sustainable forest management.

### **Building on the Global Forest Resources Assessment**

The platform features data and metadata reported to FAO’s Global Forest Resources Assessment ([FRA](http://www.fao.org/forest-resources-assessment/en/)) 2020. FRA supports countries in reporting to the main forest-related processes, including the Convention on Biological Diversity (CBD), the UN Framework Convention on Climate Change (UNFCCC), UN Forum on Forests (UNFF) and the Sustainable Development Goals (SDGs).
...
FAO trains the National Correspondents on how to compile country reports using agreed terms and definitions and a standardized reporting methodology. This [process](https://www.youtube.com/watch?v=SmMyfNlZ-jQ) is crucial for consistent reporting across countries.

The results of the assessment are offered to the public in a number of formats, including a [report with all the details](https://doi.org/10.4060/ca9825en) and a summary [digital report](http://www.fao.org/forest-resources-assessment/2020/en/), which are also available in all the six official UN languages, as well as a [report with key findings](https://doi.org/10.4060/ca8753en).

### **Making Forest Information Easier to Use**

The FRA [reporting and dissemination platform](https://fra-data.fao.org/) was produced with the assistance of the European Union, the Government of Finland, the Government of Norway and the Global Environment Facility (GEF). With the open, user-friendly platform, users can visualize FRA data using dashboards and interact with the complete dataset from the most recent global forest resources assessment. The platform provides access to:
...
To learn more about FAO’s support for countries in reporting forest data and tracking progress towards SDG 15, an e-Learning course is available in [English](https://elearning.fao.org/course/view.php?id=446), [French](https://elearning.fao.org/course/view.php?id=524), and [Spanish](https://elearning.fao.org/course/view.php?id=633).

To learn more about the importance of forest-related data collection, analysis and dissemination in meeting ETF requirements, an e-Learning course is available in [Chinese](https://elearning.fao.org/course/view.php?id=647), [English](https://elearning.fao.org/course/view.php?id=587), [French](https://elearning.fao.org/course/view.php?id=616), and [Spanish](https://elearning.fao.org/course/view.php?id=610).
...
SOURCE: [SDG KNOWLEDGE HUB](http://sdg.iisd.org/commentary/guest-articles/innovative-platform-makes-forest-data-available-in-all-6-un-languages/?utm_medium=email&utm_campaign=SDG%20Weekly%20Update%20-%2029%20April%202021&utm_content=SDG%20Weekly%20Update%20-%2029%20April%202021+CID_495f4b5c67f7d6e40690a9b2e6943435&utm_source=cm)
