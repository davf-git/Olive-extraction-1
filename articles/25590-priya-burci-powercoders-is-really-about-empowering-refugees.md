---
title: 'Priya Burci: ''Powercoders is really about empowering refugees'''
date: 2020-12-09
...
[SCIENCE & TECH](https://genevasolutions.news/science-tech)|[#powercoders](https://genevasolutions.news/tags/powercoders)|[INTERVIEW](https://genevasolutions.news/articles/news)

Published on 09 December 2020, 05:55

Priya Burci: 'Powercoders is really about empowering refugees'

by [Zelda Chauvet](https://genevasolutions.news/profil/zelda-chauvet)
...
![](images/25590/02.jpg)Powercoders students in Zurich (2017). Source: Powercoders.

We really try to make sure that they're ready to integrate into a local workplace in that specific country. A job coach supports the students during the internship. The coach is someone who has worked in the country, understands workplace expectations, and flags when there may be issues that need to be resolved. This definitely alleviates the pressure on companies to be fully responsible for integrating their intern. But it also offers an important support to the intern because I think everyone knows your first job is always so daunting ! Having the right support network is key.
...
![](images/25590/03.jpg)Powercoders graduation in Basel (2019). Source: Powercoders.

**What still needs to be done to make things change?**
...
[#refugees](https://genevasolutions.news/tags/refugees) [#education](https://genevasolutions.news/tags/education-1) [#coding](https://genevasolutions.news/tags/coding) [#powercoders](https://genevasolutions.news/tags/powercoders)

SOURCE: [GENEVA SOLUTIONS](https://genevasolutions.news/science-tech/priya-burci-powercoders-is-really-about-empowering-refugees?utm_source=newsletter&utm_medium=email)
