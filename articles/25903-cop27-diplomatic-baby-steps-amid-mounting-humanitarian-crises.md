---
title: 'COP27: Diplomatic baby steps amid mounting humanitarian crises'
date: 2022-11-23
category: Climate
source: ON Network
original_id: 25903
...
* [Climate change](https://www.thenewhumanitarian.org/environment-and-disasters/climate-change "View more reports on Climate change")
* [News](https://www.thenewhumanitarian.org/news "View more reports on News")
* 21 November 2022
...
[Paula Dupraz-Dobias](https://www.thenewhumanitarian.org/authors/paula-dupraz-dobias "See articles by Paula Dupraz-Dobias")
...
After 30 years of [advocacy](https://www.thenewhumanitarian.org/interview/2022/11/15/COP27-loss-and-damage-climate-financing) and [pushback](https://www.thenewhumanitarian.org/analysis/2021/11/15/why-COP26-leaves-humanitarians-wanting-more) on the issue, arguments leaning on climate justice had a clear influence on the political agenda, with vulnerable countries and climate campaigners alike pushing similar messages.

Yeb Saño, a prominent former diplomat from the Philippines and the Southeast Asia director for Greenpeace, called it a “new dawn for climate justice”. UN Secretary-General António Guterres said it was a badly needed step “to rebuild broken trust”. Humanitarian groups branded it a “[monumental win](https://www.oxfam.org/en/press-releases/loss-and-damage-fund-cop27-monumental-win-if-properly-funded-oxfam)”, though the crucial details of how the fund work still need to be thrashed out in the coming months.
...
Questions over who will pay into the fund and how the money will be distributed are still to be negotiated. European countries argued in Sharm el-Sheikh that China and oil and gas producers such as Saudi Arabia and Qatar – all considered by [UN definitions](https://www.un.org/en/development/desa/policy/wesp/wesp_current/2014wesp_country_classification.pdf) as developing countries – should pay. They also want Russia to be included.
...
A sense of who would be eligible to receive money was at least partially provided during the last sleepless night of negotiations: Negotiators agreed to a final [wording](https://unfccc.int/sites/default/files/resource/cp2022_L19_adv.pdf) that cited “developing countries that are particularly vulnerable to the adverse effects of climate change”.
...
Germany and other G7 nations, along with their counterparts in the [Vulnerable 20](https://www.thenewhumanitarian.org/news-feature/oh-ffs-guide-climate-change-acronyms)(V20) negotiating bloc, used COP27 to announce an insurance and disaster risk finance mechanism called the Global Shield. Some critics saw it as a distraction, especially if it becomes a [substitute](https://www.welthungerhilfe.org/news/latest-articles/cop27-an-assessment-of-the-global-shield) for new funding.
...
Negotiators in Sharm el-Sheikh wrangled over issues such as what baseline to use, before finally recommitting to the previous COP’s promises. They also agreed to set up a [framework](https://unfccc.int/sites/default/files/resource/GGA_decision.pdf) to track progress on adaptation.
...
With only [4%](https://www.cgdev.org/blog/what-holding-back-private-climate-finance-africa-and-how-can-it-be-unleashed) of climate finance directed to Africa, mostly in the form of loans instead of grants, and most of it going to mitigation, Harper said: “it is clear that the developing countries who have been doing the most to protect and support refugees, sometimes for decades, demonstrating a level of global solidarity that many in the [Global] North could learn from, are not benefitting at all from even the miniscule funding that is available.”
...
Trapped in a cycle of climate-linked disasters and crushing rebuilding debt, countries like Barbados have led the push to reform the global financial system. Prime Minister Mia Mottley, has called for a range of reforms including loan conditions that would suspend payments after they are hit by disasters or pandemics. Her [Bridgetown Agenda](https://unclimatesummit.org/opinion-the-bridgetown-initiative/) suggests that substantial funds could be unlocked through debt relief, more accessible loans, and other reform measures – allowing countries to spend on recovery and reconstruction instead of paying down debt.

Mottley and others used the COP27 stage to call for an overhaul of the global financial system that has trapped climate-vulnerable countries in a cycle of debt. She argues that the Bretton Woods institutions set up following World War II, including the International Monetary Fund and the World Bank, are not serving countries that regularly face increasingly [intense and unpredictable disasters](https://www.thenewhumanitarian.org/news-feature/2022/11/17/Puerto-Rico-hurricane-disaster-response-gaps).

While loss and damage remains divisive despite progress in Egypt, there’s much greater appetite for financial reforms. Humanitarian groups and the UN’s Guterres are also [pushing for debt relief](https://www.thenewhumanitarian.org/news/2022/11/11/Myanmar-Tigray-humanitarians-debt-relief-Mediterranean-migrant-boats-Cheat-Sheet). The US has [echoed calls](https://www.bloomberg.com/news/videos/2022-11-09/inside-cop27-talks-with-john-kerry) to reform multilateral lending. Even David Malpass, the head of the World Bank, has [cited](https://www.worldbank.org/en/news/speech/2022/10/11/remarks-by-world-bank-group-president-david-malpass-to-the-g24-meeting-of-ministers-and-governors) the need to “make progress in the debt agenda”.
...
Floods and storms, which are aggravated by climate change, pushed at least [21.6 million people](https://www.internal-displacement.org/research-areas/Displacement-disasters-and-climate-change) from their homes last year, and climate change can also [intensify other causes](https://www.thenewhumanitarian.org/analysis/2021/4/26/the-climate-displacement-crisis-has-a-neglected-flipside) of displacement.

Some believe mobility should be viewed as a way that people [adapt to climate change](https://www.csis.org/analysis/putting-climate-migration-back-cop27-agenda), and say financial support for programmes that assist displaced people should be [a part of much-needed adaptation](https://issafrica.org/iss-today/could-cop27-still-shift-views-on-climate-migrants) finances in the future.
...
And refugees and displaced people themselves need seats at the COP28 table in Dubai, UNHCR [said](https://www.unhcr.org/news/briefing/2022/11/637746ec315/unhcr-refugees-displaced-people-need-seats-cop28-table.html).
...
“Gender was only marginally mentioned, if at all, in the climate talks’ decisions,” Oxfam [said](https://www.oxfam.org/en/press-releases/loss-and-damage-fund-cop27-monumental-win-if-properly-funded-oxfam).

Reem Alsalem, the UN special rapporteur on violence, has [said](https://www.ohchr.org/en/press-releases/2022/10/climate-change-threat-multiplier-women-and-girls-un-expert) that climate change represented the “most consequential threat multiplier for women and girls” and increased the risk and prevalence of violence against them.

Beverly Musili, a gender justice activist and lawyer with the Kenya Institute for Public Policy Research and Analysis, or KIPPRA, said gender still remained very much on the [backburner](https://reliefweb.int/report/world/loss-and-damage-fund-cop27-monumental-win-if-properly-funded-oxfam) during COP27.
...
There’s still a clear gender imbalance when it comes to the COP negotiating table, as underlined by the “[family shot](https://www.shechangesclimate.org/news/we-need-to-talk-about-that-cop27-leaders-photo)” of heads of state taken at the summit’s opening: Only 7 of the 110 pictured were women.

In an effort to change the balance, one group, [She Changes Climate](https://www.shechangesclimate.org/), encouraged the United Arab Emirates, which will host next year’s climate talks, to appoint a woman as COP28 president: the current minister of climate change and the environment, Mariam Almheiri.
...
The campaign for debt relief and systemic financial reform is one example. The [push](https://www.thenewhumanitarian.org/interview/2022/10/10/Vanuatu-ICJ-climate-change-advisory-opinion-International-Court-of-Justice) to bring climate change and human rights to the International Court of Justice is another.

Backed by a catchy [music video](https://www.youtube.com/watch?v=JRGh7FwK3aQ), the Pacific island nation of Vanuatu used COP27 to announce that its allies have almost [finalised a resolution](https://www.thenewhumanitarian.org/news/2022/11/18/Iran-protests-DRC-M23-Afghanistan-banks-Tuvalu-Cheat-Sheet) that could put the issue before the UN General Assembly and – if passed there – the UN’s top court.

Years of inaction at COP summits [contributed to initial plans](https://www.thenewhumanitarian.org/news-feature/2020/12/1/pacific-vanuatu-disappearing-island-climate-change-cyclone-lawsuit-migration) for legal action.

“What we have seen this week is that negotiations are not working for the most vulnerable,” [said](https://unfccc.int/event/republic-of-vanuatu-bringing-climate-change-to-the-world-s-highest-court) Ralph Regenvanu, Vanuatu’s minister for climate change.

*Edited by Irwin Loy.*

SOURCE: [THE NEW HUMANITARIAN](https://www.thenewhumanitarian.org/news/2022/11/21/COP27-climate-justice-humanitarian-crises-gender-migration-adaptation)
