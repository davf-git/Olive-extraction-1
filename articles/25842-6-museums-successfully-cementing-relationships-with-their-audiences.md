---
title: 6 museums successfully cementing relationships with their audiences
date: 2022-05-03
...
The result was the creation of ‘[Lates](https://blog.nms.ac.uk/tag/museum-lates/)’ – night-time thematic events focusing on hedonistic activities and experimental escapism. These sessions concentrated on the notion of ‘edutainment’ – history, art and culture made fun.
...
[Gamification](https://www.museumnext.com/article/how-to-avoid-the-gamification-trap-in-your-museum/) typically involves the implementation of modern technology in order to bridge the gap between art and the viewer, but Jamtli took another approach. The open-air museum allows visitors to discover Swedish folklore for themselves through story-telling and roleplaying. It effectively acts as a functional village that visitors can immerse themselves in, complete with actors who regale them with tales of a certain era.
...
The Diefenbunker in Ottawa, Canada offers an [escape game adventure](https://diefenbunker.ca/escape-room/) for visitors which takes place across the whole museum, rather than in a single room. This not only makes it the biggest escape game in the world, but it also gives visitors the chance to get to know the museum in a completely new way – one they won’t forget in a hurry.
...
A perfect example of this is the Guggenheim, which has established [Mind’s Eye](https://www.guggenheim.org/event/event_series/minds-eye)programs to provide unique sensory experiences for visitors with visual impairments. They also offer a social narrative guide, which explains to people with sensory processing disorders what they can expect from their visit.
...
Sometimes, a big statement is what’s needed in order to really capture public imagination and garner interest in a museum. This was certainly the case for the world’s first and, as yet, only [flying museum in Saudi Arabia](https://www.museumnext.com/article/all-aboard-the-worlds-first-museum-in-the-sky/).
...
**The MuseumNext Growing Audiences Summit will be held from 9th – 11thMay, and will feature inspiring ideas and case studies from those championing audience development in museums and galleries.** [**Click here**](https://www.museumnext.com/events/growing-museum-audiences-summit/) **to book your tickets now, to make sure you don’t miss out.**

###

SOURCE: [MUSEUMS NEXT](https://www.museumnext.com/article/6-museums-successfully-cementing-relationships-with-their-audiences/)
