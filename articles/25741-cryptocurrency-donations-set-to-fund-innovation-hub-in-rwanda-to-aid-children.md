---
title: Cryptocurrency donations set to fund innovation hub in Rwanda to aid children
date: 2021-07-16
category: Charities
source: ON Network
source_url: null
...
 By [Save the Children](https://www.developmentaid.org/#!/donors/view/145343/save-the-children-international-uk)• 14 july 2021

**Thousands of children in Rwanda will soon receive help from [Save the Children](https://www.developmentaid.org/#!/donors/view/145343/save-the-children-international-uk) but from an unusual source – cryptocurrency. Traditionally the reserve of the tech elite, Save the Children in Rwanda, has embarked on a new project that aims to ensure the gains associated with blockchain reach the world’s most vulnerable children.**

The project, established in partnership with the Cardano Foundation, is the latest venture for the aid agency as it looks to new cryptocurrencies to help boost donations.

Save the Children in Rwanda can now fundraise in Cardano’s cryptocurrency, ADA, having installed a payment gateway that allows ADA donations to come directly to the project without intermediaries.
...
Save the Children in Rwanda recently launched [Kumwe Hub](https://www.kumwehub.com/) to bring together innovation and impact investment across Africa, with blockchain central to both. Projects such as academic records for children crossing borders, digital IDs for refugees, and lending mechanisms for the financially excluded, are all in the pipeline to pilot through the project.
...
The project is the latest digital currency initiative by Save the Children, which was the first global NGO to accept cryptocurrency. The organization has accepted Bitcoin donations since 2013 in response to Typhoon Haiyan that struck Southeast Asia, devastating the Philippines, and can now accept multiple cryptocurrencies as donations from its cryptocurrency wallet widget.
...
SOURCE: [DEVELOPMENT AID](https://www.developmentaid.org/#!/news-stream/post/100447/cryptocurrency-donations-rwanda?utm_source=Newsletter&utm_medium=Email&utm_campaign=NewsDigest&token=d2149963-06e8-11ea-8cc5-52540068df95)

[SAVE THE CHILDREN](https://www.developmentaid.org/#!/donors/view/145343/save-the-children-international-uk)
