---
title: GCC - Gallery Climate Coalition
date: 2023-11-23
category: Climate
source: ON Network
source_url: null
...
**![](images/25537/01.jpg)**Art being transported on the road from Cornwall to Berlin in 2017 - please note, the image is suggested by the Olive Network as a banner for this post. We hope that Gallery Climate Coaliton are ok with this.

### 

### **Welcome to the Gallery Climate Coalition**

SOURCE: [GALLERY CLIMATE COALITION](https://galleryclimatecoalition.org/)
...
Central to this project is a carbon [calculator](https://galleryclimatecoalition.org/carbon-calculator/) specifically tailored to our industry. This provides users with a general overview to determine and monitor their carbon footprint, and will be freely available for use by GCC members.

In addition, our website also contains information on a range of issues including [shipping](https://galleryclimatecoalition.org/shipping/) and [travelling](https://galleryclimatecoalition.org/travel/), [packaging](https://galleryclimatecoalition.org/packaging/), [energy](https://galleryclimatecoalition.org/energy/) and [building management](https://galleryclimatecoalition.org/gallery-spaces/), [recycling](https://galleryclimatecoalition.org/recycling/), and [more](https://galleryclimatecoalition.org/resources/). This content is a starting point for a forum to be revised and continually updated as the scientific consensus evolves over the coming years. We welcome input - ideas, information, research - from our members. Data collated (anonomously) via the carbon calculator will also help track progress across our sector.
...
The GCC is a not-for-profit organisation supported by voluntary [donations](https://galleryclimatecoalition.org/donate/) and in-kind support.
...
[**BECOME A MEMBER**](https://galleryclimatecoalition.org/member/)
