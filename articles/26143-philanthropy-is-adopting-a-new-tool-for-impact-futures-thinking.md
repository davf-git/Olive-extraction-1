---
title: 'Featured Story: Philanthropy is adopting a new tool for impact: Futures thinking'
date: 2025-11-16
category: Charities
source: ON Network
source_url: null
...
*There are three practical ways Forum uses futures to build collective capacity to respond to uncertainty and deliver on impact.*[Ariel Muller](https://www.forumforthefuture.org/ariel-muller)*, Forum’s Director of Futures and Strategic Initiatives, explores the practices in this blog, the final part of a three-part series sharing lessons we have learned in using futures and foresight with civil society organisations and philanthropy over the years. You can read the first blog*[*here*](https://www.forumforthefuture.org/blog/long-term-imagination-for-impact-creative-futuring-for-civil-society-and-philanthropy)*, and second*[*here*](https://www.forumforthefuture.org/blog/long-term-imagination-for-impact-creative-futuring-for-civil-society-and-philanthropy)*.*
...
In Singapore, the [Asia Philanthropy Circle](https://asiaphilanthropycircle.org/) develop scenarios created the Future of Asian Philanthropy in 2050 which examines key driving forces in society and lays out a set of four imagined scenarios that illustrate different outcomes from these forces. The report acknowledges ‘that the future holds great unknowns’ – but this does not mean that it is entirely up to chance. This research aims to navigate the uncertainties of the future, ensuring that philanthropy remains flexible and responsive to society's urgent demands.

In Europe, [Philiea](https://philea.eu/how-we-can-help/initiatives/futures-philanthropy/#:~:text=Futures%20Philanthropy%20is%20an%20invitation,and%20continues%20asking%20relevant%20questions.) has launched a [Futures Philanthropy initiative](https://philea.eu/how-we-can-help/initiatives/futures-philanthropy/#:~:text=Futures%20Philanthropy%20is%20an%20invitation,and%20continues%20asking%20relevant%20questions.), a collaborative effort that aims to unite foundations and philanthropic organizations in a community dedicated to enhancing future-thinking capabilities within the sector. The primary focus is on fostering futures literacy – the ability to employ anticipation and imagination for improved strategic decision-making, understanding key drivers of change, and exploring emerging opportunities.

Individual philanthropies are also at work. For instance, Forum has been partnering with [ClimateWorks Foundation](https://www.climateworks.org/) who have been using horizon scanning to explore how volatility around critical minerals and food prices may impact climate funders in the future. Together, we developed the ‘[Shocks to the System’](https://www.thefuturescentre.org/shocks-to-the-system-fast-forward-to-2028/) a game that helps build networks members’ futures literacy and equip them with ways to think systemically in response to futures shocks.

Explore the [Shocks to the System](https://www.thefuturescentre.org/shocks-to-the-system-fast-forward-to-2028/) game, a 30 – 40 minute cooperative game for 2-5 people about time travelers making decisions that will determine the trajectory of the future. 
...
This blog is the final part of a blog series on the lessons we have learned in using futures and foresight with civil society organisations and philanthropy over the past couple of years, as well as case studies, process, and impact. You can read the first blog [here](https://www.forumforthefuture.org/blog/long-term-imagination-for-impact-creative-futuring-for-civil-society-and-philanthropy), and second [here](https://www.forumforthefuture.org/blog/love-futures-and-philanthropy-why-giving-in-a-polycrisis-needs-to-start-from-the-heart).

SOURCE: [FORUM FOR THE FUTURE](https://www.forumforthefuture.org/blog/philanthropy-is-adopting-a-new-tool-for-impact-futures-thinking)
