---
title: Bill Gates is ready to spend more on global health - governments should do
  the same, says foundation official
date: 2021-04-22
category: Health
source: ON Network
source_url: null
...
![](images/25717/01.jpg)Bill Gates, former Microsoft CEO and co-founder of the Bill and Melinda Gates Foundation speaks during a press conference in Tokyo

[GLOBAL HEALTH](https://genevasolutions.news/global-health)|[#Bill and Melinda Gates Foundation](https://genevasolutions.news/tags/bill-and-melinda-gates-foundation)|[NEWS](https://genevasolutions.news/articles/news)

Published on 22 April 2021, 04:53

Bill Gates is ready to spend more on global health - governments should do the same, says foundation official

by [Pokuaa Oduro-Bonsrah](https://genevasolutions.news/profil/pokuaa-oduro-bonsrah)
...
In a frank [conversation](https://www.graduateinstitute.ch/BMGF) with Suerie Moon, co-director, Global Health Centre at The Graduate Institute, Chris Elias, president of the Bill & Melinda Gates Foundation’s global development division, addressed criticism over its influence at the WHO and what the “appropriate” roles of private and public actors should be.
...
The Foundation is the second-largest funder of the World Health Organization just behind the United States, providing 9.8 per cent of the health agency’s funds. At the same time, contributions from member states have dropped from 46 per cent of the total budget in 1999 to 17 per cent last year, according to [a recent report](https://www.fondationpourgeneve.ch/wp-content/uploads/Etude_Sante_2021-1.pdf).
...
Ironically, as the Foundation is criticised on the one hand for having too much influence, yet on the other hand are expected to lobby governments in other multilateral endeavours.
...
Sharing knowledge on mechanisms like the WHO’s proposed  [Covid-19 Technology Access Pool (C-TAP)](https://healthpolicy-watch.news/europe-to-establish-emergency-biodefense-plan-to-respond-to-coronavirus-variants/), which will share intellectual property on Covid health technologies could prove useful but he stressed it is not needed now.
...
“Climate change is one of the most difficult challenges the world has ever taken on,” Bill Gates wrote in his [annual letter](https://www.gatesnotes.com/2020-Annual-Letter). “But I believe we can avoid a climate catastrophe if we take steps now to reduce emissions and find ways to adapt to a warmer world.'

In a similar vein to global health, questions about the Foundations’ role in climate change are beginning to surface.

[#Bill and Melinda Gates Foundation](https://genevasolutions.news/tags/bill-and-melinda-gates-foundation) [#WHO](https://genevasolutions.news/tags/who) [#Global Health Centre](https://genevasolutions.news/tags/global-health-centre) [#Funding](https://genevasolutions.news/tags/funding) [#governance](https://genevasolutions.news/tags/governance)

SOURCE: [GENEVA SOLUTIONS](https://genevasolutions.news/global-health/bill-gates-is-ready-to-spend-more-on-global-health-governments-should-do-the-same-says-foundation-official?utm_source=newsletter&utm_medium=email)
